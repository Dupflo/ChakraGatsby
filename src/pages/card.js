...
const Card = () => {
  ...
  return (
    <Layout>
      ...
      >
        <Image src={thumb} alt="Course Cover" />
        <Box p={5}>
          ...
          <Text isTruncated fontWeight="light" fontSize="md">
            ...
            reprehenderit duis ullamco. Irure tempor ullamco voluptate irure
            quis quis magna sint enim velit esse. Culpa excepteur reprehenderit
            sint ex incididunt reprehenderit deserunt nisi ullamco magna.
            Officia eiusmod ipsum laboris enim irure eu elit. Labore ex esse
            pariatur aliquip proident ipsum deserunt culpa eiusmod elit
            reprehenderit labore commodo pariatur. Consequat duis velit proident
            qui ad elit mollit culpa veniam.
          </Text>
